...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Automation Company</title>
                ...
                <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                 ...
                 <div class="col-lg-4 text-center text-lg-end">
                    <div class="d-inline-flex align-items-center" style="height: 45px;">
                        ...
                        <a href="#"><small class="me-3 text-light"><i class="fa fa-phone me-2"></i>+91-99235 52698 /98903 82884</small></a>
                    </div>
                </div> 
            </div>
        </div>
                ...
                <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="img/pict.webp" class="img-fluid" alt="Image">
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Let's The World Together!</h4>
                                    <h1 class="display-2 text-capitalize text-white mb-4">Best Solution
                                        for Your Business</h1>
                                    <p class="mb-5 fs-5">360 Automation and Controls is an Automation, Software, Integration company that can accomplish a solution from your more simple to your more complex needs. 
                                    </p>
                        ...
                        <div class="carousel-item">
                            <img src="img/pic1.png" class="img-fluid" alt="Image">
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Let's The World Together!</h4>
                                    <h1 class="display-2 text-capitalize text-white mb-4">Find Your Perfect solution</h1>
                                    <p class="mb-5 fs-5">360 Automation and Controls is an Automation, Software, Integration company that can accomplish a solution from your more simple to your more complex needs. 
                                    </p>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="#">Discover Now</a>
                        ...
                        <div class="carousel-item">
                            <img src="https://www.shutterstock.com/image-photo/automation-business-industrial-process-workflow-260nw-1225883908.jpg" class="img-fluid" alt="Image">
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Let's The World Together!</h4>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5">
                        <div class="h-100" style="border: 50px solid; border-color: transparent #13357B transparent #13357B;">
                            <img src="img/pic5.png" class="img-fluid w-100 h-100" alt="">
                        </div>
                    </div>
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(img/about-img-1.png);">
                        <h5 class="section-about-title pe-3">About Us</h5>
                        <h1 class="mb-4">Welcome to <span class="text-primary">360 Automation and Controls Private Limited</span></h1>
                        <p class="mb-4">
                            <!-- 360 Automation and Controls was established in 2016 as 360 Automation and Controls LLP and becomes 360 Automation and Controls Pvt Ltd. in 2021 to provide the highest quality engineering and automation services required in the industry. Our services includes electrical control system design and schematics, pneumatic systems schematics, control software design and development, PLC, HMI, SCADA programming and system integration, IT & ITES , Dashboard-MES/MMS/ERP/SAP integration, Control & Power Panel manufacturing. 360 Automation and Controls served many companies in the world in USA, Mexico, Germany, England, Thailand, India for some of our customers like C-Tec Automation Mexico, EU & UK, Level One Robotics & Automation Thailand, Austin Fraser UK, COMAU UK, Invenpro Malaysia, Tata Motors, Mahindra & Mahindra, Fiat India, Comau India, Wooshin India just to mention some of them. -->
                            360 Automation and Controls was established in 2016 as 360 Automation and Controls LLP and becomes 360 Automation and Controls Pvt Ltd.  
                        </p> 
                        <p class="mb-4">360 Automation and Controls served end user like Tata Motors (India), Mahindra & Mahindra (India), FIAT (India), Mercedes-Benz (India), MG Motors (India), Ford (India), Ford (USA, Thailand, Germany), 
                            Jaguar and land Rover (UK, EU), JSW (India) just to mention some of them. 360 Automation and Controls is an Automation, Software, Integration company that can accomplish a solution from your more simple to your more complex needs. 
                           </p>
                        <div class="row gy-2 gx-4 mb-4">
                            <!-- <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>First Class Services</p>
                            </div> -->
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Automation and engineering services</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Programming standard Expertise</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Latest Technology Support</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Industry digitalization</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Trunkey projects</p>
                            </div>
                            <div class="col-sm-6">
...
<!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#about">
  ...
  <!-- Modal -->
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                                    <div class="service-content text-end">
                                        <h5 class="mb-4">PLC / Control System Software Programming, Design, and Development:
                                        </h5>
                                        <p class="mb-0">Creating software solutions for Programmable Logic Controllers (PLC) and control systems.
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center  bg-white border border-primary rounded p-4 pe-0">
                                    <div class="service-content text-end">
                                        <h5 class="mb-4">HMI, SCADA Design, and Development:
                                        </h5>
                                        <p class="mb-0">Designing and developing Human-Machine Interface (HMI) and Supervisory Control and Data Acquisition (SCADA) systems.
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                                    <div class="service-content text-end">
                                        <h5 class="mb-4">Robot Programming:
                                        </h5>
                                        <p class="mb-0">Programming robots for various applications and industries.
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                                    <div class="service-content text-end">
                                        <h5 class="mb-4">System Integration:
                                        </h5>
                                        <p class="mb-0">Integrating different systems and technologies to provide comprehensive solutions.
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content text-end">
                                        <h5 class="mb-4">Industry 4.0, IoT, Data Services:

                                        </h5>
                                        <p class="mb-0">Offering solutions related to Industry 4.0, Internet of Things (IoT), and data services.
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content">
                                        <h5 class="mb-4">Electrical Control System Design and Schematics:
                                        </h5>
                                        <p class="mb-0">Designing electrical control systems and providing schematics.
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content">
                                        <h5 class="mb-4">Control & Power Panel / Cabinet Design and Manufacturing:
                                        </h5>
                                        <p class="mb-0">Designing and manufacturing control and power panels or cabinets.
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content">
                                        <h5 class="mb-4">Pneumatic Systems Schematics:
                                        </h5>
                                        <p class="mb-0">Creating schematics for pneumatic systems.
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content">
                                        <h5 class="mb-4">IT & ITES:
                                        </h5>
                                        <p class="mb-0">Providing Information Technology (IT) and IT Enabled Services (ITES).
                            ...
                            <div class="col-12">
                                <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content">
                                        <h5 class="mb-4">Dashboard-MES/MMS/ERP/SAP Integration:

                                        </h5>
                                        <p class="mb-0">Integrating dashboards with Manufacturing Execution Systems (MES), Maintenance Management Systems (MMS), Enterprise Resource Planning (ERP), and SAP systems.
                                            These services collectively showcase the company's expertise in control system programming, automation, and integration, spanning a wide range of industries and applications.
                    ...
                    <div class="col-12">
                        <div class="text-center">
                            <a class="btn btn-primary rounded-pill py-3 px-5 mt-2" href="services.html">Service More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid guide py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">FOUNDER DIRECTORS</h5>
                        ...
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="https://th.bing.com/th/id/OIP.Hg-nxHemeIjazUnsnAwGwQHaEo?w=208&h=130&c=7&r=0&o=5&dpr=1.3&pid=1.7" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                ...
                <div class="testimonial-carousel owl-carousel">
                    <div class="testimonial-item text-center rounded pb-4">
                        <!-- <div class="testimonial-comment bg-light rounded p-4">
                            <p class="text-center mb-5" style="background-image: url(img/mahindra.png); height:120px  ;background-repeat: no-repeat ;width:120px">
                            </p>
                        </div> -->
                        <div class="testimonial-img p-1">
                            <img src="img/tata.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/fiat.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                        <!-- <div style="margin-top: -35px;">
                            <h5 class="mb-0">John Abraham</h5>
                            <p class="mb-0">New York, USA</p>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/mg.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                        <!-- <div style="margin-top: -35px;">
                            <h5 class="mb-0">John Abraham</h5>
                            <p class="mb-0">New York, USA</p>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/t1.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/force.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/ford.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/kopl.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/givau.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/schelf.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/land.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="img/mahindra.png" class="img-fluid rounded-circle" alt="Image">
                        </div>
        ...
        <div class="container-fluid subscribe py-5">
            <div class="container text-center py-5">
                <div class="mx-auto text-center" style="max-width: 900px;">
                    ...
                    <p class="text-white mb-5">It seems like 360 Automation and Controls Pvt. Ltd. positions itself as a comprehensive solution provider, leveraging its versatility, engineering expertise, and partnerships to meet the diverse needs of its clients.

                    </p>
                    <div class="position-relative mx-auto">
                        <input id="emailInput" class="form-control border-primary rounded-pill w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email">
                        <button id="subscribeButton" type="button" class="btn btn-primary rounded-pill position-absolute top-0 end-0 py-2 px-4 mt-2 me-2" onclick="subscribe()">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href=""><i class="fas fa-home me-2"></i> S. No. 141/1, B2/13, Yashodevi Avenue, Pimple Saudagar, Pune-411027</a>
                            <a href=""><i class="fas fa-envelope me-2"></i> sales@360acpl.com
                            </a>
                            <a href=""><i class="fas fa-phone me-2"></i> +91-99235 52698 </a>
                            <a href="" class="mb-3"><i class="fas fa-print me-2"></i> 98903 82884</a>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-end mb-md-0">
                        <i class="fas fa-copyright me-2"></i><a class="text-white" href="#">360 AUTOMATION AND CONTROLS</a>, All right reserved.
                    </div>
                    <div class="col-md-6 text-center text-md-start">
                        <!--/*** This template is free as long as you keep the below author’s credit link/attribution link/backlink. ***/-->
                        <!--/*** If you'd like to use the template without the below author’s credit link/attribution link/backlink, ***/-->
                        <!--/*** you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". ***/-->
                        Designed By <a class="text-white" href="">Tomar Vaishnavi</a>
                    </div>
                    </div>
                </div>
            </div>
